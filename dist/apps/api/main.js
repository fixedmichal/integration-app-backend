...
const database_1 = __webpack_require__("./libs/api/database/src/index.ts");
const integrations_1 = __webpack_require__("./libs/api/integrations/src/index.ts");
const categories_1 = __webpack_require__("./libs/api/categories/src/index.ts");
const category_items_1 = __webpack_require__("./libs/api/category-items/src/index.ts");
const versions_1 = __webpack_require__("./libs/api/versions/src/index.ts");
let AppModule = class AppModule {
};
AppModule = tslib_1.__decorate([
    (0, common_1.Module)({
        imports: [database_1.DatabaseModule, integrations_1.IntegrationsModule, categories_1.CategoriesModule, category_items_1.CategoryItemsModule, versions_1.VersionsModule],
    })
], AppModule);
...
/***/ "./libs/api/categories/src/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/api/categories/src/lib/controllers/categories.controller.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/categories/src/lib/services/categories.service.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/categories/src/lib/categories.module.ts"), exports);


/***/ }),

/***/ "./libs/api/categories/src/lib/categories.module.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const categories_controller_1 = __webpack_require__("./libs/api/categories/src/lib/controllers/categories.controller.ts");
const categories_service_1 = __webpack_require__("./libs/api/categories/src/lib/services/categories.service.ts");
const database_1 = __webpack_require__("./libs/api/database/src/index.ts");
...
/***/ "./libs/api/categories/src/lib/controllers/categories.controller.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const categories_service_1 = __webpack_require__("./libs/api/categories/src/lib/services/categories.service.ts");
let CategoriesController = class CategoriesController extends core_1.AbstractController {
    constructor(service) {
        super(service);
...
/***/ "./libs/api/categories/src/lib/services/categories.service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const core_1 = __webpack_require__("./libs/api/core/src/index.ts");
const database_1 = __webpack_require__("./libs/api/database/src/index.ts");
let CategoriesService = class CategoriesService extends core_1.AbstractService {
    constructor(db) {
        super(db);
        this.db = db;
...
CategoriesService = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof database_1.DatabaseService !== "undefined" && database_1.DatabaseService) === "function" ? _a : Object])
], CategoriesService);
...
/***/ "./libs/api/category-items/src/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/api/category-items/src/lib/controllers/category-items.controller.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/category-items/src/lib/services/category-items.service.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/category-items/src/lib/category-items.module.ts"), exports);


/***/ }),

/***/ "./libs/api/category-items/src/lib/category-items.module.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CategoryItemsModule = void 0;
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const category_items_controller_1 = __webpack_require__("./libs/api/category-items/src/lib/controllers/category-items.controller.ts");
const category_items_service_1 = __webpack_require__("./libs/api/category-items/src/lib/services/category-items.service.ts");
const database_1 = __webpack_require__("./libs/api/database/src/index.ts");
let CategoryItemsModule = class CategoryItemsModule {
};
CategoryItemsModule = tslib_1.__decorate([
    (0, common_1.Module)({
        imports: [database_1.DatabaseModule],
        controllers: [category_items_controller_1.CategoryItemsController],
        providers: [category_items_service_1.CategoryItemsService],
        exports: [category_items_service_1.CategoryItemsService],
    })
], CategoryItemsModule);
exports.CategoryItemsModule = CategoryItemsModule;


/***/ }),

/***/ "./libs/api/category-items/src/lib/controllers/category-items.controller.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CategoryItemsController = void 0;
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const category_items_service_1 = __webpack_require__("./libs/api/category-items/src/lib/services/category-items.service.ts");
const core_1 = __webpack_require__("./libs/api/core/src/index.ts");
let CategoryItemsController = class CategoryItemsController extends core_1.AbstractController {
    constructor(service) {
        super(service);
        this.service = service;
    }
};
CategoryItemsController = tslib_1.__decorate([
    (0, common_1.Controller)('category-items'),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof category_items_service_1.CategoryItemsService !== "undefined" && category_items_service_1.CategoryItemsService) === "function" ? _a : Object])
], CategoryItemsController);
exports.CategoryItemsController = CategoryItemsController;


/***/ }),

/***/ "./libs/api/category-items/src/lib/services/category-items.service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CategoryItemsService = void 0;
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const core_1 = __webpack_require__("./libs/api/core/src/index.ts");
const database_1 = __webpack_require__("./libs/api/database/src/index.ts");
let CategoryItemsService = class CategoryItemsService extends core_1.AbstractService {
    constructor(db) {
        super(db);
        this.db = db;
...
CategoryItemsService = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof database_1.DatabaseService !== "undefined" && database_1.DatabaseService) === "function" ? _a : Object])
], CategoryItemsService);
exports.CategoryItemsService = CategoryItemsService;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/api/core/src/lib/core.module.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/core/src/lib/abstract-controller.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/core/src/lib/abstract-service.ts"), exports);


/***/ }),

/***/ "./libs/api/core/src/lib/abstract-controller.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./libs/api/core/src/lib/abstract-service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
class AbstractService {
    ...
    findOne(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                // @ts-ignore
                return yield this.db[this.entityName].findFirst({ where: { id } });
            }
            catch (e) {
                this.logError(e);
                throw new common_1.HttpException(`FindOne ${this.entityName} error`, common_1.HttpStatus.BAD_REQUEST);
            }
        });
    }
    findAll() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                // @ts-ignore
                return yield this.db[this.entityName].findMany();
            }
            catch (e) {
                this.logError(e);
                throw new common_1.HttpException(`FindAll ${this.entityName} error`, common_1.HttpStatus.BAD_REQUEST);
            }
        });
    }
    create(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                // @ts-ignore
                return yield this.db[this.entityName].create({ data });
            }
            catch (e) {
                this.logError(e);
                throw new common_1.HttpException(`Create ${this.entityName} error`, common_1.HttpStatus.BAD_REQUEST);
            }
        });
    }
    update(id, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                // @ts-ignore
                return yield this.db[this.entityName].update({
                    where: { id },
                    data
                });
            }
                ...
                this.logError(e);
                throw new common_1.HttpException(`Update ${this.entityName} error`, common_1.HttpStatus.BAD_REQUEST);
            }
        });
    }
    remove(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                // @ts-ignore
                return yield this.db[this.entityName].delete({ where: { id } });
            }
            catch (e) {
                this.logError(e);
                throw new common_1.HttpException(`Remove ${this.entityName} error`, common_1.HttpStatus.BAD_REQUEST);
            }
        });
    }
    logError(e) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/api/database/src/lib/database.service.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/database/src/lib/database.module.ts"), exports);


/***/ }),

/***/ "./libs/api/database/src/lib/database.module.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const database_service_1 = __webpack_require__("./libs/api/database/src/lib/database.service.ts");
...
/***/ "./libs/api/database/src/lib/database.service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
let DatabaseService = class DatabaseService extends client_1.PrismaClient {
    onModuleInit() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            common_1.Logger.log('Initializing connection...', 'DatabaseService');
            yield this.$connect();
            common_1.Logger.log('Connected.', 'DatabaseService');
        });
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/api/integrations/src/lib/controllers/integrations.controller.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/integrations/src/lib/services/integrations.service.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/integrations/src/lib/integrations.module.ts"), exports);


/***/ }),

/***/ "./libs/api/integrations/src/lib/controllers/integrations.controller.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const integrations_service_1 = __webpack_require__("./libs/api/integrations/src/lib/services/integrations.service.ts");
const core_1 = __webpack_require__("./libs/api/core/src/index.ts");
let IntegrationsController = class IntegrationsController extends core_1.AbstractController {
    constructor(service) {
        super(service);
        this.service = service;
    }
    findFull(id) {
        ...
        if (isNaN(parsed) || parsed !== parseInt(id)) {
            return new common_1.BadRequestException('Invalid ID, expected type integer');
        }
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [String]),
    tslib_1.__metadata("design:returntype", void 0)
], IntegrationsController.prototype, "findFull", null);
IntegrationsController = tslib_1.__decorate([
    (0, common_1.Controller)('integrations'),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof integrations_service_1.IntegrationsService !== "undefined" && integrations_service_1.IntegrationsService) === "function" ? _a : Object])
...
/***/ "./libs/api/integrations/src/lib/integrations.module.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const integrations_controller_1 = __webpack_require__("./libs/api/integrations/src/lib/controllers/integrations.controller.ts");
const integrations_service_1 = __webpack_require__("./libs/api/integrations/src/lib/services/integrations.service.ts");
const database_1 = __webpack_require__("./libs/api/database/src/index.ts");
let IntegrationsModule = class IntegrationsModule {
};
IntegrationsModule = tslib_1.__decorate([
    (0, common_1.Module)({
        imports: [database_1.DatabaseModule],
...
/***/ "./libs/api/integrations/src/lib/services/integrations.service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const database_1 = __webpack_require__("./libs/api/database/src/index.ts");
const core_1 = __webpack_require__("./libs/api/core/src/index.ts");
let IntegrationsService = class IntegrationsService extends core_1.AbstractService {
    constructor(db) {
        super(db);
        this.db = db;
    ...
    findFull(id) {
        /* eslint-disable */ console.log(...oo_oo(`3930153866_17_4_17_19_4`, id));
...
IntegrationsService = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof database_1.DatabaseService !== "undefined" && database_1.DatabaseService) === "function" ? _a : Object])
], IntegrationsService);
...
/***/ "./libs/api/versions/src/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/api/versions/src/lib/controllers/versions.controller.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/versions/src/lib/services/versions.service.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/api/versions/src/lib/versions.module.ts"), exports);


/***/ }),

/***/ "./libs/api/versions/src/lib/controllers/versions.controller.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const versions_service_1 = __webpack_require__("./libs/api/versions/src/lib/services/versions.service.ts");
const core_1 = __webpack_require__("./libs/api/core/src/index.ts");
let VersionsController = class VersionsController extends core_1.AbstractController {
    constructor(service) {
        super(service);
        this.service = service;
    }
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [String]),
    tslib_1.__metadata("design:returntype", void 0)
], VersionsController.prototype, "duplicate", null);
VersionsController = tslib_1.__decorate([
    (0, common_1.Controller)('versions'),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof versions_service_1.VersionsService !== "undefined" && versions_service_1.VersionsService) === "function" ? _a : Object])
], VersionsController);
...
/***/ "./libs/api/versions/src/lib/services/versions.service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const core_1 = __webpack_require__("./libs/api/core/src/index.ts");
const database_1 = __webpack_require__("./libs/api/database/src/index.ts");
let VersionsService = class VersionsService extends core_1.AbstractService {
    constructor(db) {
        super(db);
        this.db = db;
    ...
    duplicate(originId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const versionToCopy = yield this.findOne(+originId);
            if (!versionToCopy) {
                throw new common_1.HttpException(`Version not found`, common_1.HttpStatus.NOT_FOUND);
            }
            const { name, id, integrationId } = versionToCopy;
            const catItemsToCopy = yield this.db.categoryItem.findMany({ where: { versionId: id } });
            try {
                const versionCopy = yield this.create({ name: name + ' copy', integrationId });
                const newCatItems = catItemsToCopy.map(item => {
                    const result = Object.assign(Object.assign({}, item), { versionId: versionCopy.id });
                    delete result.id;
                    return result;
                });
                yield Promise.all(newCatItems.map(data => this.db.categoryItem.create({ data })));
                return this.db.version.findFirst({ where: { id: versionCopy.id }, include: { categoryItems: true } });
            }
            catch (e) {
                throw new common_1.HttpException(`Duplicate Version error`, common_1.HttpStatus.BAD_REQUEST);
            }
        });
    }
};
...
/***/ "./libs/api/versions/src/lib/versions.module.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const versions_controller_1 = __webpack_require__("./libs/api/versions/src/lib/controllers/versions.controller.ts");
const versions_service_1 = __webpack_require__("./libs/api/versions/src/lib/services/versions.service.ts");
const database_1 = __webpack_require__("./libs/api/database/src/index.ts");
let VersionsModule = class VersionsModule {
};
VersionsModule = tslib_1.__decorate([
    (0, common_1.Module)({
        imports: [database_1.DatabaseModule],
...
const debugRoutes = (app) => {
    ...
    /* eslint-disable */ console.log(...oo_oo(`828822837_43_2_43_47_4`, '------------------------------'));
    /* eslint-disable */ console.log(...oo_oo(`828822837_44_2_44_34_4`, 'AVAILABLE ROUTES:'));
    /* eslint-disable */ console.log(...oo_oo(`828822837_45_2_45_47_4`, '------------------------------'));
    /* eslint-disable */ console.log(...oo_oo(`828822837_46_2_52_3_4`, availableRoutes
        .map((item) => item.route.method.toUpperCase() + '\t' + item.route.path)
        .join('\n')));
};
bootstrap();
/* istanbul ignore next */ /* c8 ignore start */ /* eslint-disable */ ;
